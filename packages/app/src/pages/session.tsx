...
import {
  PlanReviewPanel,
  type PlanComment as PlanCommentInfo,
  type PlanCommentActions,
} from "@opencode-ai/session-ui/plan-review-panel"
...
export default function Page() {
  ...
  const sideChatOpen = createMemo(() => !!layout.sideChat.sessionID())
  const desktopSideChatOpen = createMemo(() => isDesktop() && sideChatOpen())
  const desktopSidePanelOpen = createMemo(
    () => desktopSessionResizeOpen() || desktopFileTreeOpen() || desktopSideChatOpen(),
  )
  ...
  const sessionPanelWidth = createMemo(() => {
    ...
    if (desktopSessionResizeOpen() || desktopSideChatOpen()) return `${sessionPanelResizedWidth()}px`
    return `calc(100% - ${layout.fileTree.width()}px)`
  })
  const centered = createMemo(() => isDesktop() && !sideChatOpen() && (newSessionDesign() || !desktopReviewOpen()))
    ...
    <SessionRouteFrame>
      ...
      >
        ...
        >
          ...
          <Show when={desktopSessionResizeOpen() || desktopSideChatOpen()}>
            ...
            <>
              <Show when={!newSessionDesign() && desktopSidePanelOpen()}>
                <SessionSidePanel
                  ...
                  hasReview={hasReview}
                  reviewHasFocusableContent={() => hasReview() || showPlanPanel()}
                      ...
                      <div class="min-h-0 flex-1">
                        <SessionSidePanel
                          ...
                          reviewHasFocusableContent={() =>
                            hasReview() || showPlanPanel() || reviewV2State.sidebarOpened()
                          }
                          reviewCount={reviewCount}
