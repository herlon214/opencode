export const dict = {
  ...
  "command.project.picker": "Open project picker",
  ...
  "command.session.side": "Side chat",
  "command.session.side.description": "Fork this session into a side panel to ask side questions",
  "sideChat.empty": "Ask a side question below",
  "sideChat.loading": "Loading side chat…",
  ...
  "session.followupDock.remove": "Remove message",
  ...
  "settings.general.row.focusMode.description":
    "Collapse the in-progress steps block by default instead of expanding it",
  ...
  "settings.folderAccess.row.readWrite": "RW",
