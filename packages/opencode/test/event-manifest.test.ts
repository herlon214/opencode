...
describe("public event manifest", () => {
  test("contains every latest public wire type once", () => {
    ...
    expect(EventManifest.Latest.has("plan_comment.added")).toBe(true)
    expect(EventManifest.Latest.has("plan_comment.removed")).toBe(true)
    expect(EventManifest.Latest.has("plan_comment.cleared")).toBe(true)
  })
