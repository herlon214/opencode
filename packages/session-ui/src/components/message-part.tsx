  ...
  render(props) {
    ...
    const trigger = () => (
      ...
      >
        <div data-slot="basic-tool-tool-info-structured">
          <div data-slot="basic-tool-tool-info-main">
            <Show when={running()} fallback={<span data-slot="basic-tool-tool-indicator" style={{ color: tone() ?? "var(--icon-interactive-base)" }}><Icon name="task" size="small" /></span>}>
            ...
            <span data-component="task-tool-title" style={{ color: tone() ?? "var(--text-strong)" }}>{title()}</span>
            <Show when={subtitle()}>
