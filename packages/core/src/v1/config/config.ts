...
export const Info = Schema.Struct({
  ...
  workflows: Schema.optional(Schema.Record(Schema.String, ConfigWorkflowV1.Info)).annotate({
    description: "Workflow configuration, see https://opencode.ai/docs/workflows",
  }),
