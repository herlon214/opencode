...
export function Prompt(props: PromptProps) {
  ...
  createEffect(() => {
    ...
    if (sessionID !== syncedSessionID) {
      ...
      // Once a session-scoped override exists, the session store is the source
      // of truth and we leave it alone so unsent tweaks survive tab switches.
      if (local.model.hasSession(sessionID)) return
